...
<template>
    <nav  class='bg-[#ffffff00] py-5 relative '>
      <div class="justify-around flex container m-auto ">
        ...
        <ul class="z-50 flex flex-row  gap-4 text-lg	font-normal	 lg:static lg:w-auto lg:bg-transparent absolute left-0 bg-white w-full ${toggleMenu ? 'h-80' : 'h-0'} lg:h-auto duration-500 overflow-hidden top-full lg:shadow-none shadow-md">
    ...
    <div class=" flex gap-7 mt-10 justify-center">
